...
[`@aws-sdk/client-sso-admin`](https://www.npmjs.com/package/@aws-sdk/client-sso-admin/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sso-admin@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p+DAw89+GB5c4b/CzbUDoPrb5imgUwxjB8/ctth0bj1OZDWSfMTnxUuzi6/DACGy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sso-admin": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sso-admin@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sso-admin@3.933.0/index.min.mjs": "sha384-p+DAw89+GB5c4b/CzbUDoPrb5imgUwxjB8/ctth0bj1OZDWSfMTnxUuzi6/DACGy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sso-admin/blob/refs/tags/3.933.0/LICENSE
```
