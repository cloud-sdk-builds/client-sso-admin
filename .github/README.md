...
[`@aws-sdk/client-sso-admin`](https://www.npmjs.com/package/@aws-sdk/client-sso-admin/v/3.1107.0).
...
- @aws-sdk/client-sso-admin v3.1107.0 - [https://cloud-sdk-builds.github.io/?sdk=client-sso-admin&version=3.1107.0](https://cloud-sdk-builds.github.io/?sdk=client-sso-admin&version=3.1107.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sso-admin@3.1107.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sKhSB9vlIVDnYAH0crjQXAJhBA5a+v7TbEb4+fIAKXN8GS8xf6oP1+Jz5dpri/3f
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sso-admin/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sso-admin": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sso-admin@3.1107.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sso-admin@3.1107.0/index.min.mjs": "sha384-sKhSB9vlIVDnYAH0crjQXAJhBA5a+v7TbEb4+fIAKXN8GS8xf6oP1+Jz5dpri/3f"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-sso-admin";
...
```
https://github.com/cloud-sdk-builds/client-sso-admin/blob/refs/tags/3.1107.0/LICENSE
```
